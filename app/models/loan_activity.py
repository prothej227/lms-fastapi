...
class LoanActivity(Base):
    ...
    activity_date = Column(DateTime, default=lambda: datetime.now(timezone.utc), nullable=False)
    amount = Column(Numeric(10, 2), nullable=False)
    activity_type = Column(String(50), nullable=False)  # e.g., 'Payment', 'Penalty', etc.
